...
export default function SubmissionForm(){
 ...
 async function submit(e:FormEvent<HTMLFormElement>){
  ...
  try{
   ...
   setStatus('sent'); setMessage('Artifact received. We’ll review the scope and reply before any evaluation begins.'); form.reset();
 ...
 return <form className={styles.form} onSubmit={submit}>
  ...
  <label className={styles.upload}>Upload artifact <span>PDF, DOCX, TXT or MD · max 8 MB</span><input name="artifact" type="file" required accept=".pdf,.doc,.docx,.txt,.md,application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,text/plain,text/markdown"/></label>
