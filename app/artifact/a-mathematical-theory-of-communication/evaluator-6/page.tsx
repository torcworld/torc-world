...
export default function Page(){const report=evaluatorReports[5];return <main><header className="page-title"><div className="eyebrow">Independent evaluation 6 of 7</div><h1>A Mathematical Theory of Communication</h1><p className="lede">Claude E. Shannon</p></header><section className="section prose">{report.split('\n').map(renderLine)}</section><Link className="button" href="/artifact/a-mathematical-theory-of-communication">← Back to artifact</Link></main>}
