...
function OdysseyFallback(){return <ArtifactAnalysis
 ...
 order='2' orderName='Symbolic consciousness' cms={833} range='Median across 10 evaluations'
 ...
 dimensions={[
  ...
  {key:'ID',name:'Inferential Distance',score:'8',artifact:'The viewer must infer large conceptual relations from minimal exposition, but recurring structure keeps those relations recoverable.'},
  {key:'IC',name:'Integrative Compression',score:'9',artifact:'A few images and transitions carry enormous historical and conceptual load; the bone-to-spacecraft cut is an extreme local example.'},
