 ...
 return <main className={styles.page}>
   ...
   <article className={`${styles.essay} ${styles.essayAfterDimensions}`}>
     <section className={styles.boundary}>
       <Link className={`${styles.methodologyCta} ${styles.orderModelCta}`} href="/methodology#operational-order"><span>TORC classification model</span><strong>Explore all seven cognitive orders</strong><span aria-hidden="true">→</span></Link>
