...
export const featuredAnalyses:Record<string,FeaturedAnalysis>={
 ...
 'the-handmaids-tale':{
  ...
  dimensions:[
   {key:'RL',name:'Relational Load',score:'8.15',artifact:'Gender, religion, language, reproduction, law, household organization, memory and surveillance constrain one another throughout Gilead.'},
   {key:'AD',name:'Abstraction Depth',score:'7.88',artifact:'The novel moves from embodied experience into questions of language, historical reconstruction and ideological reality without leaving the narrative case behind.'},
   {key:'CD',name:'Constraint Density',score:'8.03',artifact:'Institutional rules, forbidden knowledge, reproductive ritual and narrative uncertainty impose tightly interacting constraints.'},
   {key:'ID',name:'Inferential Distance',score:'7.63',artifact:'The reader reconstructs the regime and Offred’s past from incomplete, retrospective and sometimes uncertain evidence.'},
   {key:'IC',name:'Integrative Compression',score:'8.33',artifact:'Names, uniforms, ritual, scripture and literacy prohibitions compress a broad political and psychological system with striking economy.'},
   {key:'GR',name:'Generalization Reach',score:'7.61',artifact:'The structure transfers strongly to problems of authoritarian information control, ideological capture and institutionalized identity.'}
  ],
 ...
 'the-truman-show':{
  ...
  dimensions:[
   {key:'RL',name:'Relational Load',score:'7.71',artifact:'Family, friendship, media, geography, production logistics, fear and surveillance coordinate closely around Truman’s artificial reality.'},
   {key:'AD',name:'Abstraction Depth',score:'7.52',artifact:'The concrete television premise supports broader questions of mediation, authenticity and evidence while remaining narratively direct.'},
   {key:'CD',name:'Constraint Density',score:'7.89',artifact:'The constructed world must keep thousands of behavioral, spatial and production constraints aligned without exposing itself.'},
   {key:'ID',name:'Inferential Distance',score:'7.40',artifact:'Truman reconstructs the hidden mechanism from accumulating anomalies, a substantial but comparatively legible inferential path.'},
   {key:'IC',name:'Integrative Compression',score:'8.12',artifact:'A simple television-set premise efficiently coordinates surveillance, commodification, social performance and epistemic control.'},
   {key:'GR',name:'Generalization Reach',score:'7.14',artifact:'The structure travels well to mediated reality and social control, though its governing mechanism remains unusually specific and explicit.'}
  ],
  boundaryTitle:'Why 3a, not 3b?',
  boundary:[
 ...
 'notes-from-underground':{
  ...
  dimensions:[
   {key:'RL',name:'Relational Load',score:'7.47',artifact:'Freedom, resentment, rationality, humiliation, desire, social recognition and self-consciousness repeatedly alter one another.'},
   {key:'AD',name:'Abstraction Depth',score:'8.34',artifact:'Concrete humiliations open into sustained questions about freedom, rational agency and the pathology of reflective consciousness.'},
   {key:'CD',name:'Constraint Density',score:'7.40',artifact:'Voice, memory, pride and social position strongly constrain each encounter, though the monologic form preserves some latitude.'},
   {key:'ID',name:'Inferential Distance',score:'8.20',artifact:'The reader must reconstruct how a consciousness claiming lucidity becomes the mechanism of its own repeated defeat.'},
   {key:'IC',name:'Integrative Compression',score:'8.28',artifact:'A narrow set of encounters compresses a large philosophical and psychological problem into one recursive voice.'},
   {key:'GR',name:'Generalization Reach',score:'7.46',artifact:'The structure transfers strongly to self-sabotage, ressentiment, hyper-reflection and conflicts between autonomy and recognition.'}
  ],
 ...
 'waiting-for-godot':{
  ...
  dimensions:[
   {key:'RL',name:'Relational Load',score:'7.26',artifact:'Memory, time, dependency, expectation, action and identity remain tightly related despite the tiny dramatic inventory.'},
   {key:'AD',name:'Abstraction Depth',score:'8.09',artifact:'Minimal concrete action supports sustained structures of temporality, purpose, uncertainty and existential dependence.'},
   {key:'CD',name:'Constraint Density',score:'7.60',artifact:'Repetition, paired characters, limited setting and recurring promises tightly constrain what can change and what cannot.'},
   {key:'ID',name:'Inferential Distance',score:'7.76',artifact:'The audience must infer the governing existential structure from sparse events whose factual status is repeatedly unstable.'},
   {key:'IC',name:'Integrative Compression',score:'8.44',artifact:'A road, a tree, two pairs, hats, boots and waiting coordinate an enormous field with extraordinary economy.'},
   {key:'GR',name:'Generalization Reach',score:'7.35',artifact:'Its structure travels strongly to suspended agency, dependence on future resolution and unstable temporal orientation.'}
  ],
