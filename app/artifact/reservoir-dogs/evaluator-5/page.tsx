...
export default function Page(){const report=evaluatorReports[4];return <main><header className="page-title"><div className="eyebrow">Independent evaluation 5 of 7</div><h1>Reservoir Dogs</h1><p className="lede">Quentin Tarantino · screenplay</p></header><section className="section prose">{report.split('\n').map(renderLine)}</section><Link className="button" href="/artifact/reservoir-dogs">← Back to artifact</Link></main>}
