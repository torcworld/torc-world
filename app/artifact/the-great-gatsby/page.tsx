 ...
 return <main className={styles.page}>
   ...
   <article className={`${styles.essay} ${styles.essayAfterDimensions}`}>
     <section className={styles.boundary}>
       ...
       <Link className={`${styles.methodologyCta} ${styles.orderModelCta}`} href="/methodology#operational-architecture"><span>TORC classification model</span><strong>Explore Operational Modes & G</strong><span aria-hidden="true">→</span></Link>
     </section>
   </article>
