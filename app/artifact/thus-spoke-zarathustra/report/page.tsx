import Link from 'next/link';import {consensusReport} from '@/lib/zarathustra_reports';
...
export default function Page(){return <main><header className="page-title"><div className="eyebrow">Consensus report</div><h1>Thus Spoke Zarathustra</h1><p className="lede">3c | 825 · Seven-evaluator consensus</p></header><section className="section prose">{consensusReport.split('\n').map(renderLine)}</section><Link className="button" href="/artifact/thus-spoke-zarathustra">← Back to artifact</Link></main>}