...
export default function Page(){const report=evaluatorReports[3];return <main><header className="page-title"><div className="eyebrow">Evaluator 4</div><h1>Thus Spoke Zarathustra</h1><p className="lede">Independent TORC evaluation</p></header><section className="section prose">{report.split('\n').map(renderLine)}</section><Link className="button" href="/artifact/thus-spoke-zarathustra">← Back to artifact</Link></main>}