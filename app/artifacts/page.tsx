...
export default function Artifacts(){
 ...
 <div className="archiveCommission"><div><b>Put Your Name in the TORC Archive</b><span>Choose a film, book, album, song, artwork, or other known artifact that is not yet on TORC.world. Commission its independent TORC/DIP evaluation for $9.99 and, if you want, have your name, initials, or nickname permanently credited with it in the archive.</span></div><Link className="button primary" href="/commission">Commission — $9.99</Link></div>
