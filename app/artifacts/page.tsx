...
export default function Artifacts(){
 ...
 <div className="archiveCommission"><div><b>Can't find the artifact?</b><span>Commission a public artifact for independent TORC/DIP evaluation, permanent addition to the archive, and optional commissioner credit.</span></div><Link className="button primary" href="/commission">Commission — $9.99</Link></div>
