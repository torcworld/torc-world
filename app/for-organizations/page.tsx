  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.output}>
        <div className={styles.sectionHeading}>
          <div>
            ...
            <h2>Not just scores.<br/>A view of the corpus.</h2>
          </div>
          <p>
      ...
      <section className={styles.principle}>
        <div className={styles.sectionLabel}>METHODOLOGICAL INDEPENDENCE</div>
        <div>
          <h2>The client can change the scale.<br/>Not the standard.</h2>
          <p>
            TORC can adapt workflow, reporting depth, and implementation to an organization.
