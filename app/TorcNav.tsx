...
export default function TorcNav(){
  ...
  return <nav className={styles.navRoot} aria-label="Primary navigation">
    ...
    <div className={styles.navLinks}>
      ...
      <Link className={`${styles.submitLink} ${active('/evaluate-your-work')?styles.activeLink:''}`} aria-current={active('/evaluate-your-work')?'page':undefined} href="/evaluate-your-work">TORC for Writers</Link>
